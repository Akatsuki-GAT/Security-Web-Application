...
What needs to be done is to: (SOLVED)
...
Composer, mySQL and PHP(XAMPP takes care the two of em) as I don't know if my other members machine spec is available or at a low end that running may crash or not run at all. (ignore this is just record of my log in case I forgot)
